class Tools
	...
	def main
		...
		while true
			trap("INT", "SIG_IGN")
			list = [
			'use', 'auxiliary/vulnerability/buffer_overflow_basic',
			'exploit/python/reverse_tcp', 'clear' 'cls'
			].sort
			...
			case input
			when "use exploitreverse_tcp"
				self.exploitPythonReverseTCP()
				break
